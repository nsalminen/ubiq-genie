...
export class generative3DmodelbyCode extends ApplicationController {
    components: {
        mediaReceiver?: MediaReceiver;
        speech2text?: SpeechToTextService;
        codeGenerationService?: CodeGenerationService;
        evaluationReceiver?: MessageReader;
    ...
    registerComponents() {
        ...
        this.components.evaluationReceiver = new MessageReader(this.scene, 94);
    ...
    definePipeline() {
        ...
        this.components.speech2text?.on('data', (data: Buffer, identifier: string) => {
            ...
            var threshold = 2; //for filtering useless responses
        ...
        //STEP 4 this service receive the image and send to LLM 
        this.components.evaluationReceiver?.on('data', (data: any) => {
...
if (fileURLToPath(import.meta.url) === path.resolve(process.argv[1])) {
    ...
    const app = new generative3DmodelbyCode(absConfigPath);
    app.start();
}
